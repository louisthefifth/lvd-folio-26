            ...
            <div className="flex-1">
              {project.isInternal ? (
                <Link to={project.link} className="block">
                  <h2
                    className="text-6xl sm:text-7xl lg:text-8xl font-semibold tracking-tight text-transparent transition-colors duration-300 hover:text-[#0a0a0a]"
                    style={{ WebkitTextStroke: '1.5px rgba(10,10,10,0.6)' }}
                  >
            ...
            <div className="flex flex-1 flex-col justify-between gap-8 md:items-end min-h-[120px]">
              ...
              {project.tags && (
                <div className="flex flex-wrap justify-start gap-3 md:justify-end mt-auto">
                  {[project.tags.industry, project.tags.businessModel, project.tags.discipline].filter(Boolean).map((tag, i) => (
                    <span
                      key={i}
